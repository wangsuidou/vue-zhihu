...
export const FETCH_NEWS_DETAIL = 'FETCH_NEWS_DETAIL'  //日报详情
export const FETCH_THEMES = 'FETCH_THEMES'  //专题类
...
export const TOGGLE_NEWS_DETSIL = 'TOGGLE_NEWS_DETSIL'
export const TOGGLE_THEMES = 'TOGGLE_THEMES'
export const TOGGLE_THEMES_LIST = 'TOGGLE_THEMES_LIST'
...
export const DONE_NEWS_LIST_MORE = 'DONE_NEWS_LIST_MORE'
export const DONE_THEMES = 'DONE_THEMES'
